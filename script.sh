...
echo "Tools    : Sedikit Kumpulan Script Termux $red                         " |lolcat
echo "Creadby  : gebidinfo $yellow                                      " |lolcat
echo "instagram  : hallo_catur   $green                             " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : gebidinfo" | lolcat
exit
;;
